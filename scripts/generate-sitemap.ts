...
const STATIC_ROUTES: { path: string; changefreq?: string; priority?: string }[] = [
  ...
  { path: "/envidracamento-de-sacadas-zona-norte-sp", changefreq: "monthly", priority: "0.9" },
  { path: "/envidracamento-de-sacadas-zona-sul-sp", changefreq: "monthly", priority: "0.9" },
  { path: "/envidracamento-de-sacadas-zona-leste-sp", changefreq: "monthly", priority: "0.9" },
  { path: "/envidracamento-de-sacadas-zona-oeste-sp", changefreq: "monthly", priority: "0.9" },
