          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-12 rounded-2xl bg-petrol p-8 md:p-10 text-center">
              ...
              <h3 className="font-display text-2xl md:text-3xl text-primary-foreground mb-6">
                Quer ver fotos reais dos últimos boxes que instalamos aqui no {bairroNome}? Clique aqui e solicite os modelos pelo WhatsApp!
              </h3>
              <a
                href={waUrl}
                target="_blank"
              ...
              >
                ...
                VER FOTOS DOS BOXES EM {bairroNome.toUpperCase()}
              </a>
            </div>
          </div>
        </article>
