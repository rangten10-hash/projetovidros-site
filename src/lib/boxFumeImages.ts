...
// substituir os PNGs mantendo os mesmos nomes (fume-1.png ... fume-5.png).
export const BOX_FUME_IMAGES = [
  { src: "/assets/box-fume/fume-1.png", alt: "Box de banheiro fumê de canto com perfil preto premium" },
  { src: "/assets/box-fume/fume-2.png", alt: "Box de vidro fumê frontal de correr com acabamento preto" },
  { src: "/assets/box-fume/fume-3.png", alt: "Box de vidro fumê de abrir em banheiro moderno" },
  { src: "/assets/box-fume/fume-4.png", alt: "Box de vidro fumê com nicho iluminado e pastilhas" },
