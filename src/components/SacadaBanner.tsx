  ...
  return (
    <section className="relative h-full w-full overflow-hidden bg-[#1a1a1a] lg:pt-24">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-6">
        ...
        <span className="mt-6 md:mt-8 inline-block bg-[#25D366] text-white px-6 md:px-10 py-3 md:py-4 rounded-full text-xs sm:text-sm md:text-base font-bold uppercase tracking-wide shadow-[0_8px_24px_rgba(0,0,0,0.45)]">
